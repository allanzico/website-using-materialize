...
document.querySelector("#nav-toggle").addEventListener("click", function () {
  ...
  if (open) {
    ...
    document.getElementById("side-menu").style.transitionDuration = "1s"; // document.getElementById("index-container").style.marginLeft = "350px";
    //document.body.style.backgroundColor = "rgba(0,0,0,0.4)";
    ...
    document.getElementById("side-menu").style.width = "0";
    document.getElementById("side-menu").style.transitionDuration = "1s"; // document.getElementById("index-container").style.marginLeft = "0";
    //document.body.style.backgroundColor = "white";
